...
- entrare nella pagina delle impostazioni del proprio profilo GitHub (click sull'immagine di profilo in alto a destra, poi click sulla voce *"Settings"* nel menù a tendina che compare);
  ...
  ![screen1.jpeg](/Users/manuelrobertomatera/Desktop/uni/2°%20anno/IngSoftware/progetto2223-codd/docs/img/screen1.jpeg)
...
- entrare nella sezione delle impostazioni per sviluppatori, *"Developer Settings"*, facendo click sul relativo pulsante nella barra laterale;
  ...
  ![screen2.jpeg](/Users/manuelrobertomatera/Desktop/uni/2°%20anno/IngSoftware/progetto2223-codd/docs/img/screen2.jpeg)

- selezionare *"Personal Access Tokens"* nella barra laterale, poi cliccare su "Tokens (classic)" e successivamente fare click su *"Generate new Token (classic)"*, in alto a destra;
  
  ![screen3.jpeg](/Users/manuelrobertomatera/Desktop/uni/2°%20anno/IngSoftware/progetto2223-codd/docs/img/screen3.jpeg)
...
- selezionare gli ambiti di validità del token (*"Scopes"*). Per consentire al processo Docker di caricare un'immagine su GitHub Packages, il set minimale di scope da abilitare è il seguente (vedi figura):
  ...
  - `read:packages`
    ...
    ![screen4.jpeg](/Users/manuelrobertomatera/Desktop/uni/2°%20anno/IngSoftware/progetto2223-codd/docs/img/screen4.jpeg)
...
- recarsi sulla pagina principale del repository e fare click sull'icona *"Settings"* (ultima tab in alto a destra);
  **N.B.**: solo l'amministratore visualizza questa tab!
  ...
  ![screen5.jpeg](/Users/manuelrobertomatera/Desktop/uni/2°%20anno/IngSoftware/progetto2223-codd/docs/img/screen5.jpeg)
...
- entrare nella pagina principale del repository e cliccare su `Actions` (subito sotto il titolo, in alto al centro);
  ...
  ![screen6.jpeg](/Users/manuelrobertomatera/Desktop/uni/2°%20anno/IngSoftware/progetto2223-codd/docs/img/screen6.jpeg)
